...
export function KindergartenDesignChooser({ config, activeLayout, onLayoutChange }: Props) {
  ...
  useEffect(() => {
    ...
    const run = () => {
      ...
      map.innerHTML = '<div class="bcFooterMapTitle">Bizi Nerede Bulabilirsiniz?</div><div class="bcFooterMapWrap"><iframe title="Bilim Çocuk Anaokulu konumu" src="' + mapSrc + '" loading="lazy"></iframe></div><div class="bcFooterMapAddress">📍 ' + address + '</div>';
