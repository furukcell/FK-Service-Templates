...
function mountHeroDecorations() {
  ...
  decor.innerHTML = `
    ...
    <svg class="pk-doodle pk-doodle-rocket" viewBox="0 0 100 120"><path d="M50 7c20 13 27 37 21 63l-8 22H37l-8-22C23 44 30 20 50 7Z"/><circle cx="50" cy="42" r="9"/><path d="M37 70 22 84l12 1M63 70l15 14-12 1M42 92l-6 17 14-9 14 9-6-17"/><path d="M42 103q8 10 16 0"/></svg>
